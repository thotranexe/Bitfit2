...
class AddEntryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_addentry, container, false)
        itemNameEditText = view.findViewById(R.id.foodName)
        itemCalEditText = view.findViewById(R.id.foodCalories)
        itemRecordButton = view.findViewById(R.id.recordFood)
